...
9. একই পেজে **"CA certificate"** দেখারও অপশন থাকবে। **(ঐচ্ছিক)** — সরাসরি পরীক্ষা করে (PDO দিয়ে) নিশ্চিত হয়েছি PHP-এর mysql ড্রাইভার এই CA cert ছাড়াও Aiven-এর SSL-required সংযোগে ঠিকমতো কানেক্ট করতে পারে, তাই এটা বাদ দিলেও deploy কাজ করবে — চাইলে অতিরিক্ত নিরাপত্তার জন্য কপি করে `DB_SSL_CA_CONTENT`-এ বসাতে পারেন, না দিলেও সমস্যা নেই।
