@extends('documents::print.layout', ['title' => 'Seat Plan — '.$exam->name])
...
@section('print-styles')
    ...
    .seatp:last-child{page-break-after:auto}
...
@else
    @foreach($rooms as $room)
        <div class="seatp">
            <div class="top">
                <h2>{{ $exam->name }}</h2>
                <div class="r">{{ __('ui.classroom') }}: {{ optional($room['classroom'])->room_no }}</div>
            </div>
            <table>
                <thead>
                    <tr>
