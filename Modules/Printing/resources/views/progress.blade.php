...
@section('title', __('ui.progress_card'))

@section('content')
<div class="page-head"><h1>{{ __('ui.progress_card') }}</h1></div>

<div class="card">
    <form method="GET" action="{{ route('printing.progress') }}">
        <div class="grid">
            <div>
...
<div class="card">
    <form method="POST" action="{{ route('printing.progress.generate') }}" target="_blank">
        @csrf
