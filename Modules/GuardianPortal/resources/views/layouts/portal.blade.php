...
<head>
    ...
    <title>@yield('title', __('ui.parent_portal')) — {{ config('app.name') }}</title>
    <style>
        :root{
        ...
        *{box-sizing:border-box}
        ...
        nav.portal-tabs .row{display:flex;gap:.3rem}
...
<header class="portal">
    <div class="wrap row">
        <a href="{{ route('portal.dashboard') }}" class="brand">{{ config('app.name') }}<small>{{ __('ui.parent_portal') }}</small></a>
        <div class="who">
...
<nav class="portal-tabs">
    <div class="wrap row">
        <a href="{{ route('portal.dashboard') }}" class="{{ request()->routeIs('portal.dashboard') || request()->routeIs('portal.children.*') ? 'active' : '' }}">{{ __('ui.dashboard') }}</a>
        <a href="{{ route('portal.payments.index') }}" class="{{ request()->routeIs('portal.payments.*') ? 'active' : '' }}">{{ __('ui.payment_history') }}</a>
        <a href="{{ route('portal.notices.index') }}" class="{{ request()->routeIs('portal.notices.*') ? 'active' : '' }}">{{ __('ui.notices') }}</a>
    </div>
</nav>
<main class="content">
    <div class="wrap">
